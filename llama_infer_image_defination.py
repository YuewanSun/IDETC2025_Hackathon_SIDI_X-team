...
INPUT_CSV = r"rule_definition_qa.csv"       # must have columns: prompt, image
OUTPUT_CSV = r"rule_definition_qa_2.csv"
...
image_folder = r"C:\Users\ys25268\OneDrive - The University of Texas at Austin\Windows\Reaserch2\IDECT_hackathon\design_qa\dataset\rule_comprehension\rule_definition_qa"
outputs = []
user_constrain="Give a list of components name, split by comma, do not include any other text"
